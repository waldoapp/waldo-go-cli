...
const (
	BashCompFilenameExt     = "xcmd_annotation_bash_completion_filename_extensions"
	BashCompCustom          = "xcmd_annotation_bash_completion_custom"
	BashCompOneRequiredFlag = "xcmd_annotation_bash_completion_one_required_flag"
	BashCompSubdirsInDir    = "xcmd_annotation_bash_completion_subdirs_in_dir"
)
